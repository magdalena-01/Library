...
namespace Library.Controllers
{
    public class BooksController : Controller
    {
        ...
        // GET: Books
        // GET: Books
        public async Task<IActionResult> Index(string searchString, int? authorId, int? genreId)
        {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,YearPublished,NumPages,Description,Publisher,FrontPage,DownloadUrl,AuthorId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,YearPublished,NumPages,Description,Publisher,FrontPage,DownloadUrl,AuthorId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
